                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="/profile"
                        className={`hidden group relative items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/profile" ||
